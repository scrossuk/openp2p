#ifndef P2P_RPC_PROTOCOL_HPP
#define P2P_RPC_PROTOCOL_HPP
...
#include <p2p/Condition.hpp>
#include <p2p/IdGenerator.hpp>
#include <p2p/Lock.hpp>
#include <p2p/Mutex.hpp>
#include <p2p/Signal.hpp>

#include <p2p/RPC/Socket.hpp>
